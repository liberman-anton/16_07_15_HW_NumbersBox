...
void removeNumber(int number);//only first
...
/**
 * this numbers box will add all numbers from the given numbers box 
 * except those already existed in this 
 * 
 * @param numbers
 */
...
/**
 * 
 * this numbers box will contain all unrepeated numbers except those existing in the given one
 * example: this - {2,2,5,5,7,7}, this given - {5,7} : result - {2}
 * @param numbers
 */
